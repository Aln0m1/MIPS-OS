...
struct File {
	...
	uint32_t f_dir_block;	// disk block of parent directory FCB
	uint32_t f_dir_offset;	// byte offset of parent directory FCB in block
	char f_pad[FILE_STRUCT_SIZE - MAXNAMELEN - (3 + NDIRECT) * 4 - 8];
